...
gastos_medio_residencia <- cbind(gastos_medio_residencia, Country_Ids)


gastos_medio_viz <- gastos_medio_residencia %>% left_join(countries, by=join_by(Country_Ids == CNTR_ID))



# Mapa base 
geographic_map_gasto_medio <- ggplot(gastos_medio_viz) 
