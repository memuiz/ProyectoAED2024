...
media_total = media_otros x (194-5)/194 + (5/194)x sum(media_paises) Por comunidad autonoma y por año media_otros = (media_total - (5/194)x sum(media_paises) ) \* 194/(194-5)
